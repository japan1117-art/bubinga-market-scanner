...
|---|---:|---:|---:|---:|
| AO | 35 | 27.65 | 35 | 19.25 |
| RSI | 30 | 23.7 | 30 | 16.5 |
| Stochastic | 35 | 27.65 | 35 | 19.25 |

倍率はEarly 0.79、Optimal 1.00、Late 0.55、条件外0。合計は画面表示時に整数へ四捨五入する。

Early 0.79はタイミング前倒しv0.1として、従来の0.70からOptimal 1.00までの残り0.30のうち30%を先取りした値である（`0.70 + 0.30 × 0.30 = 0.79`）。全指標がEarlyの場合は79点になる。MAゲート、Late、条件外、強い逆転警戒の条件は緩和しない。
